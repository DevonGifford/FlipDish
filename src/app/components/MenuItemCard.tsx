...
const MenuItemCard: React.FC<MenuItemCardProps> = ({
  ...
  return (
    <Link href="/" passHref>
      <article className="flex flex-row w-full justify-between max-h-36 min-h-[90px] py-4 pb-4 gap-2 md:gap-3 border-b  cursor-pointer transition duration-400 hover:scale-99">
        ...
        <div className="flex flex-row w-full">
          ...
          <div className="flex-none h-full text-sm font-medium">
